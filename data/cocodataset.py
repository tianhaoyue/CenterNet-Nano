...
coco_class_labels = ('background', 'holothurian', 'echinus', 'scallop', 'starfish',)

coco_class_index = [1, 2, 3, 4, ]


coco_root = '/home/cc631//hailong/data/water/1600/COCO/'
...
class COCODataset(Dataset):
    ...
    def pull_image(self, index):
        ...
        if self.json_file == 'instances_train2017.json' and img is None:
            img_file = os.path.join(self.data_dir, 'train2017',
                                    '{:06}'.format(id_) + '.jpg')
            img = cv2.imread(img_file)

        elif self.json_file == 'instances_val2017.json' and img is None:
    ...
    def pull_item(self, index):
        ...
        if self.mosaic and np.random.randint(2):
            ...
            for id_ in ids:
                ...
                if self.json_file == 'instances_train2017.json' and img_i is None:
                    img_file = os.path.join(self.data_dir, 'train2017',
                                            '{:06}'.format(id_) + '.jpg')
                    img_i = cv2.imread(img_file)
...
if __name__ == "__main__":
    ...
    img_size = 640
    dataset = COCODataset(
                data_dir = '/home/cc631//hailong/data/water/1600/COCO/',
                img_size=img_size,
