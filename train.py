...
def parse_args():
    ...
    parser.add_argument('-v', '--version', default='centernet',
                        help='centernet')
    parser.add_argument('-bk', '--backbone', default='mbv3',
                        help='r18, r34, r50, r101, mbv2, mbv3, shuffv2, ghost')
    parser.add_argument('--dete', default='FPN',
                        help='bace, spp, dw, decode')
...
def train():
    ...
    if args.tfboard:
        ...
        log_path = os.path.join('log/coco/', args.backbone, args.dete)
