...
parser.add_argument('-v', '--version', default='centernet',
                    help='centernet')
parser.add_argument('-bk', '--backbone', default='mbv2',
                    help='r18, r34, r50, r101, mbv2, mbv3, shuffv2, ghost')
parser.add_argument('-d', '--dataset', default='coco-val',
                    help='voc, coco-val.')
parser.add_argument('-size', '--input_size', default=512, type=int,
                    help='input_size')
parser.add_argument('--trained_model', default='weights/coco/centernet_70.pth',
...
def test(net, device, testset, transform, thresh, class_colors=None, class_names=None, class_indexs=None,
    ...
    print("detection time used ", t_all / num_images, "s")
    print("FPS =  ", num_images / t_all)
